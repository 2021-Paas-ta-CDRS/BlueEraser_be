...
from .views import CertificateAPI, CreateDoctorAPI, DoctorInfoAPI, ReadOnlyDoctorAPI, ReadOnlyCertificateAPI, UpdateDoctorAPI
...
urlpatterns = [
    ...
    path('info/', DoctorInfoAPI.as_view()),
